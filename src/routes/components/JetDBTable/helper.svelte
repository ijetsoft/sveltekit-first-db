...
export function appendTD(parmTR: HTMLTableRowElement, 
  parmTD: HTMLTableCellElement, parmStyle: CSSStyleDeclaration ) {
   
   parmTD.style.border = parmStyle.border;
   parmTD.style.padding = parmStyle.padding;
